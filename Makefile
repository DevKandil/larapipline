...
migrate:
	...
	docker compose -f docker-compose.yml exec app php artisan migrate --force --seed
...
fresh:
	...
	docker compose -f docker-compose.yml exec app php artisan migrate:fresh --seed

# Optimize clear
oc:
	@echo "⚙️  Running optimize clear..."
	docker compose -f docker-compose.yml exec app php artisan o:c